...
| ------- | ------- | ----------- |
| `gdoge` | 20170425 | [pdf](https://github.com/dogeum-network/go-dogeum/blob/master/docs/audits/2017-04-25_Gdoge-audit_Truesec.pdf) |
...
To find out how to disclose a vulnerability in Dogeum visit [https://bounty.etherum.org](https://bounty.etherum.org) or email bounty@etherum.org. Please read the [disclosure page](https://github.com/dogeum-network/go-dogeum/security/advisories?state=published) for more information about publicly disclosed security vulnerabilities.

Use the built-in `gdoge version-check` feature to check whether the software is affected by any known vulnerability. This command will fetch the latest [`vulnerabilities.json`](https://gdoge.etherum.org/docs/vulnerabilities/vulnerabilities.json) file which contains known security vulnerabilities concerning `gdoge`, and cross-check the data against its own version number.
